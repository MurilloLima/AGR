...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">AGR</span>
    </a>
    ...
    <div
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 248px;"></div>
        ...
        <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="height: 18.3223%; transform: translate(0px, 0px);"></div>
            </div>
        </div>
